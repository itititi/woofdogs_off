        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-[#141414] rounded-lg overflow-hidden shadow-2xl p-6 sm:p-8 mb-6 sm:mb-8 border border-[#2A2A2E] relative">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
              <div className="flex items-center mb-4 sm:mb-0">
                ...
                <h1 className="text-2xl sm:text-3xl font-bold text-[#3AABEE]">{wallet.name}</h1>
              </div>
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                ...
                <div className="bg-[#2A2A2E] rounded-lg p-2 flex items-center justify-center shadow-md">
                  <span className="font-medium text-sm text-[#2AABEE]">
                    8 more...
                  </span>
                </div>
              </div>
            ...
            <button className="w-full bg-gradient-to-r from-[#2AABEE] to-[#1E90FF] text-white text-lg sm:text-xl font-bold py-3 sm:py-4 px-6 rounded-full hover:brightness-110 transition-all duration-300 shadow-lg hover:shadow-xl">
          ...
          <div className="bg-[#141414] rounded-lg overflow-hidden shadow-2xl p-6 sm:p-8 border border-[#2A2A2E]">
            <div className="flex items-center mb-4 sm:mb-6">
              ...
              />
              <h2 className="text-xl sm:text-2xl font-bold text-[#3AABEE]">What You'll Get</h2>
            </div>
            <ul className="space-y-3 text-gray-200 text-sm sm:text-base mb-6">
              <li className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-[#2AABEE]" viewBox="0 0 20 20" fill="currentColor">
