  ...
  return (
    <div className="relative max-w-xl mx-auto w-full">
      <input
        ...
        className="w-full py-2 px-4 pr-12 rounded-full bg-[#141414] text-white placeholder-gray-400 focus:outline-none text-sm h-11 leading-tight border border-[#2A2A2E] text-[16px]"
        value={searchTerm}
    ...
    <div className="bg-black pt-20 pb-4 sm:pb-6 md:pb-8 lg:pb-10 xl:pb-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto w-full">
        <div className="text-center">
          ...
          <p className="text-sm sm:text-base lg:text-lg mb-4 sm:mb-6 lg:mb-8 text-gray-300 max-w-2xl mx-auto">
