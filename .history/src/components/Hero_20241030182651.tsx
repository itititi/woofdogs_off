    ...
    <div className="bg-black pt-24 pb-6 sm:pb-8 md:pb-10 lg:pb-12 xl:pb-14 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto w-full">
        <div className="text-center">
          ...
          <div className="mb-8 sm:mb-8 leading-[1.1]">
            <span className="titanium-gradient inline-block text-[42px] sm:text-4xl md:text-5xl lg:text-6xl font-bold">
              Buy and Sell
            </span>{' '}
            <span className="text-white inline-block text-[42px] sm:text-4xl md:text-5xl lg:text-6xl font-bold">
              <AnimatedTitle />
            </span>
          </div>
          <p className="text-[20px] sm:text-lg md:text-xl lg:text-2xl mb-10 sm:mb-10 text-gray-300 max-w-2xl mx-auto leading-relaxed">
