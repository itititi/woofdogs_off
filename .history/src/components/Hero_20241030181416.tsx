...
const AnimatedTitle: React.FC = () => {
  ...
  return (
    <span className="inline-block relative text-[72px] sm:text-4xl md:text-5xl lg:text-6xl">
    ...
    <div className="bg-black pt-24 pb-6 sm:pb-8 md:pb-10 lg:pb-12 xl:pb-14 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto w-full">
        <div className="text-center">
          ...
          <h1 className="text-[72px] sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-8 sm:mb-8 leading-[1.1]">
