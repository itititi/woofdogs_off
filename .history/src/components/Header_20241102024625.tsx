              ...
              {navItems.map((item, index) => (
                item.isButton ? (
                  <Link 
                    key={index}
                    href={item.href}
                    className="relative group h-10 rounded-lg overflow-hidden flex items-center justify-center bg-gradient-to-br from-[#FF3366] to-[#FF6B6B] hover:from-[#FF6B6B] hover:to-[#FF3366] transition-all duration-300"
