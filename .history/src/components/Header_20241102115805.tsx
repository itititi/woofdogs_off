...
import { CustomTonConnect, MobileProfileButton } from './CustomTonConnect';
...
const Header: React.FC = () => {
  ...
  ].sort((a, b) => (a.priority || 0) - (b.priority || 0)), [pathname, isMobileOrTablet, showProfile, walletAddress]);
