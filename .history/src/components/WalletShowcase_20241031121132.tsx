          ...
          <div className="flex items-center gap-6 ml-6">
            ...
            <div className="flex items-center gap-8 min-w-[300px]">
              <div className="flex flex-col">
                <span className="text-[20px] font-bold bg-gradient-to-r from-[#A0D8EF] to-[#3AABEE] text-transparent bg-clip-text">
                  ${offer.priceUSD}
                </span>
        ...
        <div className="bg-[#1A1A1A] rounded-2xl p-3 sm:p-4 mt-auto">
          <div className="flex flex-col sm:flex-col gap-2">
            <div className="flex items-baseline">
              <span className="text-[18px] sm:text-[20px] font-bold bg-gradient-to-r from-[#A0D8EF] to-[#3AABEE] text-transparent bg-clip-text">
                ${offer.priceUSD}
              </span>
      ...
      <div className="max-w-[1800px] mx-auto">
        {hotOffers.length > 0 && (
          <>
            ...
            <div className="grid grid-cols-1 gap-4 px-4 sm:px-6 lg:px-8 mb-10">
        ...
        {regularOffers.length > 0 && (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-1 gap-4 px-4 sm:px-6 lg:px-8">
