...
const Header: React.FC = () => {
  ...
  const renderWalletButton = () => {
    if (!mounted || isConnected === null) {
      return (
        <div className="bg-[#141414] text-white py-2 px-4 rounded-full text-[16px] font-medium h-8 w-[140px] flex items-center justify-center border border-[#2A2A2E]">
    ...
    if (isConnected) {
      return (
        <button 
          ...
          className="bg-[#141414] text-white py-2 px-4 rounded-full text-[16px] font-medium flex items-center hover:bg-[#2A2A2E] transition-colors duration-300 h-8 border border-[#2A2A2E]"
        >
          <Avatar
            size={16}
            name="EQD....abc"
    ...
    return (
      <button
        ...
        className="bg-[#31A6F5] text-white py-2 px-4 rounded-full text-[16px] font-medium hover:bg-[#2691D9] transition-colors duration-300 h-8 border border-[#2A2A2E]"
      >
        Connect Wallet
      </button>
    );
                ...
                {navItems.map((item, index) => (
                  item.isButton ? (
                    <Link key={index} href={item.href}>
                      <button className="bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 text-white py-2 px-4 rounded-full text-[16px] font-medium h-8 flex items-center justify-center hover:brightness-110 transition-all duration-300">
