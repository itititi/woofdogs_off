...
const Header: React.FC = () => {
  ...
  const AirdropButton = () => (
    <button className="bg-gradient-to-r from-gray-700 to-gray-800 hover:from-gray-600 hover:to-gray-700 text-white font-bold py-2 px-4 rounded-full transition-all duration-300 shadow-lg">
      Airdrop
    </button>
  );
