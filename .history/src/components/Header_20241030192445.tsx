                ...
                {navItems.map((item, index) => (
                  item.isButton ? (
                    <Link key={index} href={item.href}>
                      <button className="bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 text-white py-2.5 px-5 rounded-full text-[18px] font-semibold relative overflow-hidden group transition-all duration-300 ease-out hover:scale-105">
              ...
              {navItems.map((item, index) => (
                item.isButton ? (
                  <Link 
                    key={index}
                    href={item.href}
                    className="bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 text-white py-3 px-6 rounded-full text-[20px] font-semibold text-center"
        ...
        <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-50">
          <div className="bg-black bg-opacity-80 backdrop-filter backdrop-blur-md rounded-full p-2 shadow-lg">
            {isConnected ? (
              <button 
                onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                className="bg-[#141414] text-white py-2.5 px-5 rounded-full text-[18px] font-semibold flex items-center hover:bg-[#2A2A2E] transition-colors duration-300 border border-[#2A2A2E]"
              >
                <Avatar
                  size={24}
                  name="EQD....abc"
              ...
              <button
                onClick={handleConnect}
                className="bg-[#31A6F5] text-white py-2.5 px-6 rounded-full text-[18px] font-semibold hover:bg-[#2691D9] transition-colors duration-300"
              >
                Connect Wallet
              </button>
            )}
