...
const WalletCard: React.FC<WalletCardProps> = ({ offer }) => {
  return (
    <Link href={`/wallet/${offer.id}`}>
      <div className="bg-[#141414] rounded-xl overflow-hidden shadow-lg p-4 border border-[#2A2A2E] hover:border-[#3AABEE]/20 transition-all duration-300 h-[240px] flex flex-col">
        {/* Header section */}
        <div className="flex items-center mb-3">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-[20px] font-bold titanium-gradient mb-2 truncate">{offer.name}</h1>
        ...
        {/* Description */}
        <p className="text-[14px] text-gray-300 mb-6 line-clamp-2 leading-relaxed">{offer.description}</p>

        {/* Price section */}
        <div className="bg-[#1A1A1A] rounded-2xl p-3 mt-auto">
