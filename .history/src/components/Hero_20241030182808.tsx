      ...
      <div className="max-w-4xl mx-auto w-full">
        <div className="text-center">
          ...
          <div className="mb-8 sm:mb-8 leading-[1.1]">
            <span className="titanium-gradient inline-block text-[36px] sm:text-4xl md:text-5xl lg:text-6xl font-bold">
              Buy and Sell
            </span>{' '}
            <span className="text-white inline-block text-[36px] sm:text-4xl md:text-5xl lg:text-6xl font-bold">
              <AnimatedTitle />
            </span>
          </div>
