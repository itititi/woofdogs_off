                ...
                <div className="relative">
                  ...
                  {isConnected && isDropdownOpen && (
                    <div className="absolute right-0 mt-2 w-56 rounded-xl bg-[#141414] border border-[#2A2A2E] shadow-lg">
                      <div className="py-1">
                        <Link href="/profile" className="block px-4 py-2.5 text-[14px] text-gray-300 hover:bg-[#2A2A2E] hover:text-white">
                          Profile
                        </Link>
                        <Link href="/settings" className="block px-4 py-2.5 text-[14px] text-gray-300 hover:bg-[#2A2A2E] hover:text-white">
                          Settings
                        </Link>
                        <button
                          onClick={handleLogout}
                          className="block w-full text-left px-4 py-2.5 text-[14px] text-red-400 hover:bg-[#2A2A2E] hover:text-red-500"
                        >
                          Disconnect
                        </button>
                      </div>
