                ...
                {navItems.map((item, index) => (
                  item.isButton ? (
                    <Link key={index} href={item.href} className="flex-shrink-0">
                      <button className="bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 text-white py-2 px-4 rounded-full text-[14px] font-medium h-8 flex items-center justify-center hover:brightness-110 transition-all duration-300 whitespace-nowrap">
                    ...
                    <Link 
                      ...
                      } ${item.soon ? 'opacity-50 cursor-not-allowed' : ''} flex-shrink-0`}
                      target={item.external ? "_blank" : undefined}
                      rel={item.external ? "noopener noreferrer" : undefined}
                    >
                      {item.label}
                      {item.soon && <span className="ml-1.5 text-[12px] bg-[#2A2A2E]/50 px-2 py-0.5 rounded whitespace-nowrap">Soon</span>}
                    </Link>
                  )
                ))}
              </nav>
                  ...
                  <div className="absolute right-0 mt-2 w-56 rounded-xl bg-[#141414]/95 backdrop-blur-sm border border-[#2A2A2E]/50 shadow-lg">
                    <div className="py-1">
                      <button 
                        ...
                        className="flex items-center w-full px-4 py-2.5 text-[14px] text-gray-300 hover:bg-[#2A2A2E] hover:text-white whitespace-nowrap"
                      >
                      ...
                      <button
                        ...
                        className="flex items-center w-full text-left px-4 py-2.5 text-[14px] text-red-400 hover:bg-[#2A2A2E] hover:text-red-500 whitespace-nowrap"
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-3" viewBox="0 0 20 20" fill="currentColor">
