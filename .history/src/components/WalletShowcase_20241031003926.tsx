...
const WalletCard: React.FC<WalletCardProps> = ({ offer }) => {
  return (
    <Link href={`/wallet/${offer.id}`}>
      <div className="bg-[#141414] rounded-xl overflow-hidden shadow-lg p-4 border border-[#2A2A2E] hover:border-[#3AABEE]/20 transition-all duration-300 h-[220px] flex flex-col">
        {/* Header section */}
        ...
        {/* Description */}
        <p className="text-[14px] text-gray-300 mb-auto line-clamp-2 leading-relaxed">{offer.description}</p>
