      ...
      <div className="relative">
        <div className="relative flex items-center">
          <input
            ...
            className="w-full py-3.5 px-5 pr-12 rounded-lg bg-[#141414]/80 backdrop-blur-md text-white placeholder-gray-400 focus:outline-none text-[14px] h-12 leading-tight border border-[#2A2A2E]/50 relative z-10 transition-all duration-300 focus:border-[#3AABEE]/50 hover:bg-[#1A1A1A]/80"
