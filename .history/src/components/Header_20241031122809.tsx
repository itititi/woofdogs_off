  ...
  const renderWalletButton = () => {
    ...
    if (isConnected) {
      return (
        <button 
          ...
          className="bg-[#141414] text-white py-2 px-4 rounded-full text-[14px] font-medium flex items-center hover:bg-[#2A2A2E] transition-colors duration-300 h-8 border border-[#2A2A2E]"
        >
          <Avatar
            size={16}
            name="EQD....abc"
    ...
    return (
      <button
        ...
        className="bg-[#31A6F5] text-white py-2 px-4 rounded-full text-[14px] font-medium hover:bg-[#2691D9] transition-colors duration-300 h-8 border border-[#2A2A2E] flex items-center justify-center"
      >
        Connect Wallet
      </button>
    );
