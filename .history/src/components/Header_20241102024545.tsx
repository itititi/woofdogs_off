                ...
                {navItems.map((item, index) => (
                  item.isButton ? (
                    <Link key={index} href={item.href} className="flex-shrink-0">
                      <button className="relative group h-10 px-6 rounded-lg overflow-hidden flex items-center bg-gradient-to-br from-[#FF6B6B] to-[#FFB347] hover:from-[#FFB347] hover:to-[#FF6B6B] transition-all duration-300">
                        <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent opacity-0 group-hover:opacity-100 group-hover:animate-shimmer"></div>
              ...
              {navItems.map((item, index) => (
                item.isButton ? (
                  <Link 
                    key={index}
                    href={item.href}
                    className="relative group h-10 rounded-lg overflow-hidden flex items-center justify-center bg-gradient-to-br from-[#FF6B6B] to-[#FFB347] hover:from-[#FFB347] hover:to-[#FF6B6B] transition-all duration-300"
