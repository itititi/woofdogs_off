...
const Header: React.FC = () => {
  ...
  const [profileData, setProfileData] = useState<{ address: string; id: string } | null>(null);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
          <div className="flex items-center justify-between h-[72px]">
            ...
            <div className="flex items-center space-x-3">
              {!isMobileOrTablet && profileData && (
                <Link href="/profile" className="flex items-center space-x-2 mr-2">
                  <Avatar
                    size={32}
        ...
        <div className="fixed inset-0 bg-black/95 backdrop-blur-md z-40 pt-20">
          <div className="max-w-md mx-auto px-4 h-[calc(100vh-80px)] flex flex-col">
            {profileData && (
              <Link 
                href="/profile"
                className="flex items-center space-x-3 px-4 py-3 mb-6 bg-[#141414] rounded-xl border border-[#2A2A2E]/50"
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[14px] text-gray-400">{profileData.address.slice(0, 6)}...{profileData.address.slice(-4)}</p>
                </div>
              </Link>
            )}
