        ...
        <div className="p-4 sm:p-5 flex flex-col flex-grow">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center">
              ...
              <div>
                <h3 className="text-2xl font-bold titanium-gradient">{offer.name}</h3>
                <div className="flex items-center mt-1">
                  <span className="text-yellow-400 font-semibold text-sm bg-yellow-400/10 px-2 py-1 rounded-full shadow-md mr-2 whitespace-nowrap">
                    {offer.priceRange}
                  </span>
                  {offer.isHot && (
                    <span className="text-orange-500 font-semibold text-sm bg-orange-500/10 px-2 py-1 rounded-full shadow-md animate-pulse whitespace-nowrap">
                      🔥 Hot
                    </span>
                  )}
                </div>
          ...
          <p className="text-gray-300 text-base mb-6 leading-relaxed">{offer.description}</p>
