...
// Заменяем динамический импорт на условный рендеринг
const TonConnectButton = () => {
  if (typeof window !== 'undefined') {
    const TonConnectButtonComponent = require('@tonconnect/ui-react').TonConnectButton;
    return <TonConnectButtonComponent />;
  }
  return null;
};
