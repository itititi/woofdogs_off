...
import TonConnectButtonWrapper from './TonConnectButtonWrapper';
...
const Header: React.FC = () => {
  ...
  const AirdropButton = () => (
    <button className="bg-gradient-to-r from-[#39FF14] via-[#00FF7F] to-[#32CD32] hover:from-[#32CD32] hover:via-[#00FF7F] hover:to-[#39FF14] text-black font-bold py-2 px-4 rounded-full transition-all duration-300 shadow-lg">
      Airdrop
    </button>
  );
