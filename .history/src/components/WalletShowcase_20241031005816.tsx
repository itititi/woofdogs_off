...
const WalletCard: React.FC<WalletCardProps> = ({ offer }) => {
  return (
    <Link href={`/wallet/${offer.id}`}>
      <div className="bg-[#141414] rounded-xl overflow-hidden shadow-lg p-4 sm:p-6 border border-[#2A2A2E] hover:border-[#3AABEE]/20 transition-all duration-300 h-[240px] sm:h-[280px] flex flex-col">
        {/* Header section */}
