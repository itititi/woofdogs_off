        ...
        <div className="bg-[#141414] rounded-xl overflow-hidden shadow-lg p-4 border border-[#2A2A2E] hover:border-[#3AABEE]/20 transition-all duration-300 flex items-center">
          <div className="flex items-center flex-1">
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                <h1 className="text-[20px] font-bold titanium-gradient">{offer.name}</h1>
                <span className="text-[16px]">🐸</span>
                <span className="text-[16px] text-green-400">Cool</span>
              </div>
          ...
          <div className="flex items-center gap-6 ml-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[14px] text-purple-400 font-medium bg-purple-400/10 px-3 py-1 rounded-full">
                👑 Premium
              </span>
              <span className="text-[14px] text-green-400 font-medium bg-green-400/10 px-3 py-1 rounded-full">
                ⚡️ Charged
              </span>
              <span className="text-[14px] text-blue-400 font-medium bg-blue-400/10 px-3 py-1 rounded-full">
                🎯 Cool
              </span>
            </div>
        ...
        <div className="flex items-center mb-3 sm:mb-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[14px] sm:text-[14px] text-purple-400 font-medium bg-purple-400/10 px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-full">
                👑 Premium
              </span>
              <span className="text-[14px] sm:text-[14px] text-green-400 font-medium bg-green-400/10 px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-full">
                ⚡️ Charged
              </span>
              <span className="text-[14px] sm:text-[14px] text-blue-400 font-medium bg-blue-400/10 px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-full">
                🎯 Cool
              </span>
            </div>
          </div>
    ...
    <div className="bg-black flex-grow py-4 mt-14 sm:mt-16">
      <div className="max-w-7xl mx-auto">
        ...
        {regularOffers.length > 0 && (
          <>
            <div className="border-t border-[#2A2A2E] mb-6"></div>
            <h2 className="text-[32px] font-bold titanium-gradient mb-6 text-center">
              More TON Wallets
            </h2>
