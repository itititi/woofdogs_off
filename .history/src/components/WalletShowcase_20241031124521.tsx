...
const WalletCard: React.FC<WalletCardProps> = ({ offer }) => {
  ...
  if (isLargeScreen) {
    return (
      <Link href={`/wallet/${offer.id}`}>
        <div className="bg-[#141414] rounded-xl overflow-hidden shadow-lg p-4 border border-[#2A2A2E] hover:border-[#2A2A2E]/80 hover:shadow-[0_0_15px_rgba(42,42,46,0.5)] transition-all duration-300 flex items-center">
  ...
  return (
    <Link href={`/wallet/${offer.id}`}>
      <div className="bg-[#141414] rounded-xl overflow-hidden shadow-lg p-4 sm:p-6 border border-[#2A2A2E] hover:border-[#2A2A2E]/80 hover:shadow-[0_0_15px_rgba(42,42,46,0.5)] transition-all duration-300 h-[240px] sm:h-[260px] flex flex-col">
        {/* Header section */}
