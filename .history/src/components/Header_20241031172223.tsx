                ...
                {navItems.map((item, index) => (
                  item.isButton ? (
                    <Link key={index} href={item.href}>
                      <button className="bg-gradient-to-r from-purple-500 via-pink-500 to-red-500 text-white py-2.5 px-5 rounded-full text-[15px] font-medium h-10 flex items-center justify-center hover:brightness-110 transition-all duration-300">
