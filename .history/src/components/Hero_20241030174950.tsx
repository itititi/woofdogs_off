    ...
    <div className="bg-black pt-24 pb-6 sm:pb-8 md:pb-10 lg:pb-12 xl:pb-14 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto w-full">
        <div className="text-center">
          ...
          <h1 className="text-[48px] sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
            <span className="titanium-gradient">Buy and Sell</span>{' '}
            <AnimatedTitle />
          </h1>
          <p className="text-[22px] sm:text-lg md:text-xl lg:text-2xl mb-8 sm:mb-10 text-gray-300 max-w-2xl mx-auto leading-relaxed">
