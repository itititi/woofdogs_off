    ...
    <div className="bg-black flex-grow py-4 mt-14 sm:mt-16">
      <div className="max-w-7xl mx-auto">
        ...
        {regularOffers.length > 0 && (
          <>
            <div className="border-t border-[#2A2A2E] mb-6"></div>
            <h2 className="text-[32px] font-bold titanium-gradient mb-6 text-center flex items-center justify-center gap-3">
              <span>More TON Wallets</span>
              <span className="text-[24px]">🐸</span>
              <span className="text-[24px] text-green-400">Cool</span>
            </h2>
