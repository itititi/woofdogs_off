  ...
  return (
    <div className="relative max-w-xl mx-auto w-full">
      <input
        ...
        className="w-full py-4 px-6 pr-12 rounded-full bg-[#141414] text-white placeholder-gray-400 focus:outline-none text-[18px] h-14 leading-tight border border-[#2A2A2E]"
        value={searchTerm}
    ...
    <div className="bg-black pt-24 pb-6 sm:pb-8 md:pb-10 lg:pb-12 xl:pb-14 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto w-full">
        <div className="text-center">
          ...
          <h1 className="text-[40px] sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-6 sm:mb-8 leading-tight">
            <span className="titanium-gradient">Buy and Sell</span>{' '}
            <AnimatedTitle />
          </h1>
          <p className="text-[20px] sm:text-lg md:text-xl lg:text-2xl mb-8 sm:mb-10 text-gray-300 max-w-2xl mx-auto leading-relaxed">
