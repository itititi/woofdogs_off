    ...
    <div className="bg-black pt-20 pb-4 sm:pb-6 md:pb-8 lg:pb-10 xl:pb-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto w-full">
        <div className="text-center">
          ...
          <h1 className="text-[32px] sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-6 leading-tight">
            <span className="titanium-gradient">Buy and Sell</span>{' '}
            <AnimatedTitle />
          </h1>
          <p className="text-[16px] sm:text-lg md:text-xl lg:text-2xl mb-6 sm:mb-8 text-gray-300 max-w-2xl mx-auto leading-relaxed">
