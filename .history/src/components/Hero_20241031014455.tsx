  ...
  return (
    <div className="relative max-w-xl mx-auto w-full">
      <input
        ...
        className="w-full py-2.5 px-4 pr-10 rounded-full bg-[#141414] text-white placeholder-gray-400 focus:outline-none text-[14px] h-10 leading-tight border border-[#2A2A2E] touch-manipulation"
        value={searchTerm}
