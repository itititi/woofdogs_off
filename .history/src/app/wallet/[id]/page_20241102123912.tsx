    ...
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <main className="flex-grow py-4 px-4 mt-[72px] sm:mt-20 lg:mt-24 overflow-y-auto">
        <div className="max-w-3xl mx-auto">
          <div className="bg-[#141414] rounded-xl overflow-hidden shadow-lg p-5 border border-[#2A2A2E] hover:border-[#3AABEE]/20 hover:shadow-[0_0_20px_rgba(58,171,238,0.1)] hover:bg-[#1A1A1A] transition-all duration-300">
            {/* Header section */}
