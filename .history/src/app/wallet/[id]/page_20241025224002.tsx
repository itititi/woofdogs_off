        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-[#141414] rounded-2xl overflow-hidden shadow-2xl p-4 mb-4 border border-[#2A2A2E] relative">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-stretch mb-6 bg-[#1A1A1A] p-4 rounded-lg shadow-inner">
              <div className="flex-1 mb-4 sm:mb-0 sm:mr-4">
                <div className="mb-4 pb-4 border-b border-gray-700">
                  <span className="text-sm text-gray-400 block mb-1">Wallet Balance</span>
                  <div className="flex items-baseline">
                    <span className="text-3xl font-bold titanium-gradient">${wallet.priceUSD}</span>
                    <span className="text-lg text-gray-300 ml-2">≈ {tonAmount} TON</span>
                  </div>
                </div>
                <div className="mb-4 pb-4 border-b border-gray-700">
                  <span className="text-sm text-gray-400 block mb-1">Current Bid</span>
                  <div className="flex items-baseline">
                    <span className="text-2xl font-semibold text-green-500">${bidPrice}</span>
                ...
                <div>
                  <span className="text-sm text-gray-400 block mb-1">Buy Now</span>
                  <div className="flex items-baseline">
                    <span className="text-2xl font-semibold text-yellow-500">${blitzPrice}</span>
              ...
              <div className="flex flex-col justify-center items-center sm:items-end bg-[#242424] p-4 rounded-lg">
                <span className="text-gray-400 text-sm mb-2">
                  {isAuctionEnded ? 'Auction ended' : 'Auction ends in'}
                </span>
                <span className="font-bold text-2xl text-[#FFA500]">
                  {timeLeft}
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-3 mb-4">
              ...
              >
                Place Bid: ${bidPrice} (Save ${wallet.priceUSD - bidPrice})
              </button>
              <button 
