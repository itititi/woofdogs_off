...
import { Calendar, Shield, Zap, DollarSign, Gift } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black to-gray-900 text-white flex flex-col">
      ...
      <main className="flex-grow py-8 px-4 sm:py-12 sm:px-6 lg:px-8 mt-16">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-[#1C1C1E] to-[#2A2A2E] rounded-lg overflow-hidden shadow-2xl p-6 sm:p-8 mb-6 sm:mb-8 border border-[#3A3A3E] transform hover:scale-105 transition-all duration-300">
            ...
            <button className="w-full bg-gradient-to-r from-[#2AABEE] to-[#229ED9] text-white text-xl sm:text-2xl font-bold py-4 sm:py-5 px-6 sm:px-8 rounded-full hover:brightness-110 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105">
