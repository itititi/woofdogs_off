            ...
            <div className="bg-[#1A1A1A] rounded-xl p-4 mb-4 shadow-inner">
              <div className="flex flex-col gap-3">
                <div className="flex items-baseline">
                  <span className="text-[28px] font-bold bg-gradient-to-r from-[#A0D8EF] to-[#3AABEE] text-transparent bg-clip-text">
                    ${wallet.priceUSD}
                  </span>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div>
                      <span className="text-[16px] text-gray-400">Current bid:</span>
                      <span className="text-[18px] font-semibold text-green-500 ml-2">${wallet.auctionPriceUSD}</span>
                    </div>
                    <div>
                      <span className="text-[16px] text-gray-400">Buy now:</span>
                      <span className="text-[18px] font-semibold text-yellow-500 ml-2">${buyNowPrice}</span>
                    </div>
                  </div>
                  <div className="flex items-center">
                    <span className="text-[16px] text-gray-400 mr-2">
                      {isAuctionEnded ? 'Auction ended' : 'Ends in:'}
                    </span>
