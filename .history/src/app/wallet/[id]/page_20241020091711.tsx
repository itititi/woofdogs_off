        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#1C1C1E] rounded-lg overflow-hidden shadow-xl p-6 sm:p-8 mb-6 sm:mb-8 border border-[#2A2A2E]">
            ...
            <div className="mb-6 sm:mb-8">
              <h3 className="text-xl font-bold mb-4 bg-gradient-to-r from-[#2AABEE] to-[#1E88E5] text-transparent bg-clip-text">Tokens</h3>
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                {wallet.tokens.map((tokenData, index) => (
                  <div key={index} className="bg-[#2A2A2E] rounded-lg p-3 flex items-center justify-between">
                    <div className="flex items-center">
                      <Image
                    ...
                    <span className="text-sm">{tokenData.balance.toLocaleString()}</span>
                  </div>
                ))}
              </div>
            </div>
