            ...
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 bg-[#1A1A1A] p-4 rounded-lg shadow-inner">
              <div className="mb-2 sm:mb-0 flex flex-col">
                <div className="mb-2 flex justify-between">
                  ...
                  <span className="text-lg sm:text-xl font-bold titanium-gradient">${wallet.priceUSD}</span>
                </div>
                <div className="mb-2 text-sm sm:text-base text-gray-300 text-right">
                  ≈ {tonAmount} TON
                </div>
                <div className="mb-2 flex justify-between">
                ...
                {bidPrice !== null && (
                  <div className="mb-2 text-sm sm:text-base text-green-500 text-right">
                ...
                {blitzPrice !== null && (
                  <div className="text-sm sm:text-base text-red-500 text-right">
