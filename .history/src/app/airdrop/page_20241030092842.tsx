...
const AirdropPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setReferralCount(Math.floor(Math.random() * 1000));
  }, []);
          ...
          <div className="bg-[#141414] rounded-2xl overflow-hidden shadow-2xl p-4 sm:p-6 mb-6 border border-[#2A2A2E]">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-[#1A1A1A] rounded-xl p-4 text-center">
                ...
                <p className="text-2xl sm:text-3xl font-bold text-[#3AABEE]">{referralCount.toLocaleString()}</p>
              </div>
            </div>
          </div>
                  ...
                  <div className="mt-4 bg-[#1A1A1A] rounded-lg p-3">
                    ...
                    <div className="w-full bg-[#2A2A2E] rounded-full h-2">
                      <div 
                        ...
                        style={{ width: `${(mintCount / 10000) * 100}%` }}
                      ></div>
                    </div>
                    <p className="text-xs text-gray-400 mt-2">{mintCount} / 10,000 minted</p>
                  </div>
                </div>
