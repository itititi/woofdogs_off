      ...
      <main className="container mx-auto px-4 py-4 mt-8 xl:py-8 xl:mt-16">
        ...
        {activeTab === 'mint' && (
          <section className="mb-12 text-center">
            <div className="max-w-4xl mx-auto bg-gradient-to-b from-gray-800 to-gray-900 shadow-lg rounded-lg overflow-hidden transition-all duration-300 hover:shadow-2xl border border-gray-600 xl:max-w-5xl">
              <div className="p-8">
