            ...
            <div className="bg-[#141414] rounded-xl overflow-hidden shadow-lg p-4 sm:p-6 mb-4 border border-[#2A2A2E]">
              <div className="flex flex-col sm:flex-row sm:items-start sm:space-x-6">
                <div className="mb-4 sm:mb-0 w-full sm:w-1/3">
                  <div className="relative w-[120px] sm:w-full h-[120px] sm:h-auto sm:pt-[100%] rounded-lg overflow-hidden mx-auto">
                    <Image 
                      src="/dogs.gif" 
                      alt="Dogs GIF" 
                      layout="fill"
                ...
                <div className="w-full sm:w-2/3">
                  <h2 className="text-[20px] sm:text-[24px] font-bold text-[#3AABEE] mb-3">Mint $WOOF Tokens</h2>
                  ...
                  <div className="bg-[#1A1A1A] rounded-2xl p-4 mb-4">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-[14px] font-bold text-[#3AABEE]">1000 $WOOF</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-[14px] text-gray-300">Win Chance:</span>
                      <span className="text-[14px] font-bold text-green-500">10%</span>
                    </div>
                  </div>
                  <button
                    onClick={handleMint}
                    className="w-full bg-gradient-to-r from-[#3AABEE] to-[#1E90FF] text-white text-[14px] font-bold py-3 px-6 rounded-full hover:brightness-110 transition-all duration-300 shadow-lg hover:shadow-xl mb-4"
                  >
                    Mint $WOOF
                  </button>
                  {mintResult && (
          ...
          {activeTab === 'invite' && (
            <div className="bg-[#141414] rounded-xl overflow-hidden shadow-lg p-4 sm:p-6 mb-4 border border-[#2A2A2E]">
              <div className="flex flex-col sm:flex-row sm:items-start sm:space-x-6">
                ...
                <div className="w-full sm:w-2/3">
                  <h2 className="text-[20px] sm:text-[24px] font-bold text-[#3AABEE] mb-3">Invite & Earn</h2>
                  <p className="text-[14px] mb-4 text-gray-300">
